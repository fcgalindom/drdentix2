                                                ...
                                                <tr>
                                                    <td align="center" valign="top" width="500" class="flexibleContainerCell">
                                                        ...
                                                        <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                            <tr>
                                                                <td align="center" valign="top" class="textContent bg-light-green"
                                                                style="
                                                                      background-image: url('http://dry-springs-78045.herokuapp.com/images/fondo_profile.jpeg');
                                                                      height: 10rem;
                                                                      background-size: cover;
                                                                    ">
                                                                    {{-- <img src="http://www.drdentix.tk/images/logo.png" alt="" style="height: 8rem;width: 250px;"> --}}
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <!-- // CONTENT TABLE -->
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td align="left" valign="top" class="textContent">
                                                                        <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:10px;color:#5F5F5F;line-height:135%;">¡Felicitaciones!, tus datos han sido registrados en nuestra plataforma <b> Dr. Dentix </b> de manera éxitosa.</div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                ...
                                                <tr>
                                                    <td style="padding-top:0;" align="center" valign="top" width="500" class="flexibleContainerCell">
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
                                                            <tr>
                                                                {{-- <td align="center" valign="middle" class="buttonContent bg-light-green" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;background-color: deepskyblue;">
                                                                    <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="{{$verify}}" target="_blank">Confirmar</a>
                                                                </td> --}}
                                                            </tr>
                                                        </table>
                                                        <!-- // CONTENT TABLE -->

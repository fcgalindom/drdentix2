            ...
            -->
               ...
               -->
                                                        <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                            <tr>
                                                                <td align="center" valign="top"
                                                                    class="textContent bg-light-green"
                                                                    style="
                                                                      background-image: url('http://dry-springs-78045.herokuapp.com/images/fondo_profile.jpeg');
                                                                      height: 10rem;
                                                                      background-size: cover;
                                                                    ">
                                                                    {{-- <img src="http://dry-springs-78045.herokuapp.com/images/fondo_profile.jpeg"
                                                                        alt="" style="height: 8rem;width: 250px;"> --}}
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <!-- // CONTENT TABLE -->
                                                    ...
                                                    <td valign="top" width="500" class="flexibleContainerCell">
                                                        @if ($type_petition == 1)
                                                            <div
                                                                ...
                                                                Hola, {{ $data->name }}, de parte de nuestro equipo
                                                                Dr. Dentix
                                                                queremos desearte un muy feliz cumpleaños, gracias
                                                                por elegirnos para sacar tu mejor sonrisa,
                                                                disfruta tu día juntos a tu familia y seres queridos.
                                                            </div>
                                                        @endif
                                                        @if ($type_petition == 2)
                                                        <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:10px;color:#5F5F5F;line-height:135%;">
                                                            Hola, <br>
                                                            <b>{{ $data['dPacient']['name'] }}</b> Te escribo de la clínica odontológica Dr.Dentix para confirmar tu cita agendada para el día de mañana {{date("d-m-Y", strtotime($row["day"]))}} <br>
                                                            Motivo: {{$row['denpro']['procedures']['name']}} <br>
                                                            Hora:  {{date('g:i a', strtotime($row["hour"]))}} <br>
                                                            Doctor: {{$row['denpro']['dentists']['name']}} <br>
                                                            Teléfono: +573156549290 <br>
                                                            Dirección: Carrera 4 N° 6-35 Barrio Belalcazar, Yumbo-Valle <br>
                                                            https://maps.app.goo.gl/sVEzWbdSRiC8vq757 <br><br>
                                                            <b>Dr.Dentix</b> odontologia especializada al alcanze de todos! <br><br>
                                                            ¡Te esperamos!
                                                            <br />
                                                        </div>
                                                        @endif
                                                        ...
                                                        @if ($type_petition == 3)
                                                            <div
                                                                style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:10px;color:#5F5F5F;line-height:135%;">
                                                                Hola, <b>{{ $data['dPacient']['name'] }}</b> acabas de
                                                                reservar una cita para
                                                                <b>{{ $data['denpro']['procedures']['name'] }}</b> en
                                                                nuestra
                                                                clínica odontólogica Dr.Dentix
                                                                <br />

                                                                <b>Fecha:</b> {{ $data['day'] }} <br>

                                                                <b>Hora: </b>
                                                                {{ date('g:i a', strtotime($data['hour'])) }}
                                                                <br>

                                                                <b> Doctor(a): </b>
                                                                {{ $data['denpro']['dentists']['name'] }}
                                                                <br />
                                                                <br />
                                                                ...
                                                                <br />
                                                                <b> Teléfono: +573156549290 </b>

                                                                <br />
                                                                <b> Dirección:Carrera 4 # 6-35 Barrio Belalcazar,
                                                                    Yumbo-Valle</b>

                                                                <br />
                                                                <b> https://maps.app.goo.gl/sVEzWbdSRiC8vq757</b>

                                                            </div>
                                                        @endif

                                                        @if ($type_petition == 4)
                                                            <p> Hola Dr. Dentix, felicitaciones se acaba de registrar un
                                                                nuevo paciente en nuestra plataforma. </p> <br>
                                                            <b>Nombre: </b> <span>{{ $patient->name }}</span> <br>
                                                            <b>Documento: </b> <span>{{ $user->document }}</span>
                                                            <br>
                                                            <b>Teléfono </b>
                                                            <span>{{ $patient->telephone }}</span><br>
                                                        @endif
                                                        @if ($type_petition == 5)
                                                            <div
                                                                style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:10px;color:#5F5F5F;line-height:135%;">
                                                                Hola Dr. Dentix, el paciente
                                                                <b>{{ $data['dPacient']['name'] }}</b> acaba de
                                                                reservar una cita para
                                                                <b>{{ $data['denpro']['procedures']['name'] }}</b> en
                                                                nuestra
                                                                clínica odontólogica Dr.Dentix
